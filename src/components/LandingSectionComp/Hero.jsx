    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        <div>
          ...
          <div className="flex w-full gap-4 px-1 sm:grid sm:grid-cols-2 lg:flex lg:justify-center lg:gap-6">
  {[
    {
      title: "Paying Guest",
      value: "pg",
    ...
    <div key={item.value} className="flex-1 aspect-square lg:aspect-auto lg:w-48">
      <Link
      ...
      >
        <div
          style={{ fontFamily: "heading_font" }}
          className="text-[9px] text-center lg:text-base text-zinc-700 group-hover:text-blue-600 tracking-tight"
        >
          {item.title}
        </div>
        <div
