  ...
  return (
    <section className="bg-gradient-to-b from-gray-50 to-gray-100 py-12 px-4">
      <div className="max-w-4xl mx-auto bg-white p-8 sm:p-10 rounded-2xl shadow-lg border border-zinc-200">
        <h2 style={{ fontFamily: "para_font" }} className="text-3xl sm:text-4xl  text-center text-zinc-800 mb-10">
          Terms and Conditions
        </h2>

        <div className="space-y-8 text-zinc-700 leading-relaxed">
          <div>
            <h3 className=" text-lg sm:text-xl text-zinc-800 mb-2">1. Definitions</h3>
            <p>
          ...
          <div>
            <h3 className=" text-lg sm:text-xl text-zinc-800 mb-2">2. Eligibility</h3>
          ...
          <div>
            <h3 className=" text-lg sm:text-xl text-zinc-800 mb-2">3. User Accounts</h3>
            <p>
          ...
          <div>
            <h3 className=" text-lg sm:text-xl text-zinc-800 mb-2">4. Services and Listings</h3>
            <p>
          ...
          <div>
            <h3 className=" text-lg sm:text-xl text-zinc-800 mb-2">5. Payments and Fees</h3>
            <p>
          ...
          <div>
            <h3 className=" text-lg sm:text-xl text-zinc-800 mb-2">6. Prohibited Activities</h3>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <div>
            <h3 className=" text-lg sm:text-xl text-zinc-800 mb-2">7. Intellectual Property</h3>
            <p>
          ...
          <div>
            <h3 className=" text-lg sm:text-xl text-zinc-800 mb-2">8. Privacy Policy</h3>
            <p>
          ...
          <div>
            <h3 className=" text-lg sm:text-xl text-zinc-800 mb-2">9. Limitation of Liability</h3>
            <p>
          ...
          <div>
            <h3 className=" text-lg sm:text-xl text-zinc-800 mb-2">10. Termination</h3>
            <p>
          ...
          <div>
            <h3 className=" text-lg sm:text-xl text-zinc-800 mb-2">11. Governing Law</h3>
            <p>
          ...
          <div>
            <h3 className=" text-lg sm:text-xl text-zinc-800 mb-2">12. Changes to These Terms</h3>
            <p>
          ...
          <div>
            <h3 className=" text-lg sm:text-xl text-zinc-800 mb-2">13. Contact Us</h3>
            <p>
