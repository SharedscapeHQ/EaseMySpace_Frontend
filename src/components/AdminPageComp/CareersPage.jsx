...
function TagsInput({ tags, setTags, placeholder }) {
  ...
  return (
    <div className="border rounded-md px-2 py-1 flex flex-wrap gap-1 focus-within:ring-2 focus-within:ring-indigo-300">
      {tags.map((tag, idx) => (
        <div key={idx} className="bg-indigo-100 text-indigo-700 px-2 py-1 rounded flex items-center gap-1">
          <span>{tag}</span>
          <button
            type="button"
...
export default function CareersPage() {
  ...
  return (
      ...
      <h1 style={{fontFamily:"heading_font"}} className="text-3xl  text-zinc-800 mb-6">Careers</h1>
      ...
      <div className="bg-white rounded-lg p-6 mb-6 shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {["role", "dept", "location", "salary", "experience"].map(field => (
            <input
              ...
              className="border rounded-md px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-indigo-300"
            />
          ))}
        </div>
        ...
        <textarea
          ...
          className="border rounded-md px-3 py-2 w-full mt-4 focus:outline-none focus:ring-2 focus:ring-indigo-300"
          rows={3}
        />
        ...
        {["responsibilities", "requirements", "perks"].map(field => (
          <div key={field} className="mt-3">
            <label className="text-gray-600 mb-1 block font-medium">{field.charAt(0).toUpperCase() + field.slice(1)}</label>
            <TagsInput
      ...
      <div className="flex justify-end mb-4">
        <input
          ...
          className="border rounded-md px-3 py-2 w-full md:w-64 focus:outline-none focus:ring-2 focus:ring-indigo-300"
        />
      </div>
