...
export default function Footer() {
  return (
    <footer style={{fontFamily:"para_font"}} className="bg-white border-t  border-zinc-200  py-10 overflow-x-hidden text-zinc-800">
      <div className=" mx-auto lg:px-20 px-3 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-20 items-start">
        ...
        <div className="flex flex-col justify-center lg:w-[80%] w-auto items-center gap-4 ">
          <img src={brandImg} alt="EaseMySpace" className="w-40 lg:mr-10" />
          <p className="text-sm leading-relaxed">
            EaseMySpace simplifies urban living by connecting people with flatmates and rental spaces in metro cities. Hassle-free & seamless.
          </p>
        </div>
