...
export default function PropertyCardSkeleton({ count = 20 }) {
  return (
    <div className="flex flex-col lg:flex-wrap lg:flex-row items-center lg:items-start gap-6 lg:gap-10 overflow-x-auto lg:overflow-x-visible scrollbar-hide px-4">
      {Array.from({ length: count }).map((_, i) => (
        <div
          key={i}
className="flex-shrink-0 w-80 lg:w-[13.25rem] text-left animate-pulse"
        >
          <div className="relative w-80 h-80 lg:w-[13.25rem] lg:h-[13.25rem] rounded-3xl bg-zinc-200 dark:bg-zinc-600 mx-auto lg:mx-0">
