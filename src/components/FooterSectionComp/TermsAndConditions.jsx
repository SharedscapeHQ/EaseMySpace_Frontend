    ...
    <section className="bg-gray-100 pt-5">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <div className="space-y-6 text-gray-700">
          <div>
            <h3 className="font-semibold text-lg mb-2">1. Definitions</h3>
            <p>
          ...
          <div>
            <h3 className="font-semibold text-lg mb-2">4. Services and Listings</h3>
            <p>
          ...
          <div>
            <h3 className="font-semibold text-lg mb-2">5. Payments and Fees</h3>
            <p>
          ...
          <div>
            <h3 className="font-semibold text-lg mb-2">6. Prohibited Activities</h3>
            <ul className="list-disc pl-6 space-y-1">
          ...
          <div>
            <h3 className="font-semibold text-lg mb-2">8. Privacy Policy</h3>
            <p>
          ...
          <div>
            <h3 className="font-semibold text-lg mb-2">12. Changes to These Terms</h3>
            <p>
