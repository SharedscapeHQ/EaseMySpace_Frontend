...
function Banner() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      invalidNumbers.includes(formData.phone)
    ) {
      ...
      >
        ...
        <div className="flex flex-col items-center text-center gap-4 flex-1 z-10">
          <h1
            ...
            className="text-lg md:text-xl font-medium text-zinc-900 dark:text-white"
          >
            Looking for a flatmate or have a room to rent in Mumbai?
          </h1>
          <h2
            style={{ fontFamily: "para_font" }}
            className="text-sm text-zinc-700 dark:text-zinc-300 max-w-md mx-auto"
          >
            Talk to our experts for complete guidance and get the best verified
          ...
          <div className="flex items-center justify-center gap-5">
            ...
            <a
              ...
              className="bg-green-600 dark:bg-green-500 text-white px-6 py-3 rounded-lg lg:text-base text-xs shadow hover:bg-green-700 dark:hover:bg-green-600 transition-all duration-300 ease-in-out transform hover:-translate-y-0.5 hover:shadow-lg"
          ...
          <div className="bg-white rounded-xl shadow-xl w-full max-w-3xl relative overflow-hidden flex flex-col md:flex-row">
            ...
            <div className="bg-blue-50 p-6 md:w-1/2 dark:bg-zinc-700 dark:text-white border-r border-zinc-200 dark:border-zinc-800 flex flex-col justify-center text-center md:text-left">
              <h3 className="text-zinc-800 dark:text-zinc-200   text-lg mb-4 flex items-center justify-center md:justify-start gap-1">
                ...
                <IoSparklesOutline className="text-blue-500 dark:text-blue-100 text-lg" />
              </h3>
            ...
            <div className="p-6 md:w-1/2 dark:bg-zinc-900 dark:text-white flex flex-col justify-center items-center text-center">
              {!submitted ? (
                <>
                  <h2
                    style={{ fontFamily: "para_font" }}
                    className="text-xl  text-zinc-800 dark:text-white mb-2"
                  >
                    How can we help you?
                  </h2>
                  ...
                  <form
                    ...
                    className="space-y-3 dark:text-zinc-900 w-full max-w-sm"
                  >
                    <input
                      type="text"
                      name="name"
