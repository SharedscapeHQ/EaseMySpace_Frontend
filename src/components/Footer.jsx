...
import {
  ...
  FaInstagram,
  FaLinkedin,
  FaHome, FaInfoCircle, FaThList, FaPhone, FaUndoAlt, FaFileContract, FaUserShield 
} from "react-icons/fa";
import brandImg from "/navbar-assets/brand-logo.png"

const icons = [
  { Icon: FaFacebookF, color: "from-blue-600 to-blue-800 border-blue-500/50" },
  { Icon: FaTwitter, color: "from-sky-500 to-blue-600 border-sky-400/50" },
  { Icon: FaInstagram, color: "from-pink-500 to-yellow-500 border-pink-400/50" },
  { Icon: FaLinkedin, color: "from-indigo-600 to-indigo-800 border-indigo-500/50" },
];
