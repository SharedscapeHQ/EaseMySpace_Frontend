    ...
    {selectedFeature && (
      <div className="mt-10 flex justify-start">
        <button
          ...
          className="bg-gray-100 dark:bg-zinc-800 hover:bg-gray-200 dark:hover:bg-zinc-700 px-6 py-3 rounded-xl text-gray-800 dark:text-gray-200 font-medium shadow-sm transition"
        >
          ← Back to Options
        </button>
      </div>
