    ...
    >
      ...
      <section className="pb-10 lg:px-10 pt-3 px-3">
        ...
        <p className="mt-3 text-xs lg:text-base text-zinc-700">
          Get started with our subscription plans. Manage your properties
          efficiently.
        </p>
      </section>
              ...
              <div className="lg:w-2/3 flex flex-col justify-start">
                ...
                <div className="flex justify-center lg:justify-end">
                  <ListerPaymentButton
                    plan={plan}
                    userData={userData}
                    onInvoiceGenerated={(url) => setInvoiceUrl(url)}
                  />
                </div>
              </div>
            </div>
      ...
      {selectedPlan && (
        ...
        >
          ...
          >
            ...
            <h2 style={{ fontFamily: "heading_font" }} className="text-xl mb-2">
              {selectedPlan.title}
            </h2>
