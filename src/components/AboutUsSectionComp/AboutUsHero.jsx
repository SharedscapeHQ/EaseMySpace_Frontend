...
export default function AboutUsHero() {
  ...
  return (
   <section
      ...
      className="w-full min-h-screen bg-white flex flex-col items-center justify-center px-4 relative overflow-hidden"
    >
      ...
      {images.map((img, index) => (
        <motion.img
          key={index}
          src={img.src}
          alt={`EaseMySpace verified accommodation image ${index + 1}`}
      ...
      >
        ...
        <p className="text-base sm:text-lg text-zinc-700 text-center mb-10">
  EaseMySpace is a trusted platform in Mumbai for finding{" "}
  <strong>verified flatmates</strong>, <strong>shared accommodations</strong>,{" "}
  <strong>PGs</strong>, and <strong>vacant rooms</strong>. Our mission is to simplify
  urban living by connecting compatible flatmates and offering a secure,
  reliable, and efficient rental discovery experience. Whether you are
  looking for a <strong>PG in Mumbai</strong> or want to find the perfect{" "}
  <strong>shared flat</strong>, EaseMySpace helps you do it faster and smarter. 
  As a growing startup, we are committed to expanding our services to help
  more Mumbai residents find their ideal home.
</p>
