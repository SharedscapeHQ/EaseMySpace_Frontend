    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4 sm:px-6 lg:px-20">
      ...
      <div className="max-w-7xl mx-auto bg-white shadow-md rounded-xl p-8 flex flex-col lg:flex-row gap-10">
        <div className="lg:w-[60%] space-y-6">
          <h1 style={{ fontFamily: "para_font" }} className="text-4xl capitalize  text-gray-900">
            {job.role}
          </h1>
        ...
        <div className="bg-gray-100 lg:w-[45%] p-6 rounded-lg shadow-inner">
          <h2 style={{ fontFamily: "para_font" }} className="text-2xl  mb-6 text-gray-900">
            Apply for this job
          </h2>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={submitting} className="w-full mt-6 bg-indigo-600 hover:bg-indigo-700 text-white py-3 rounded-md ">
...
function Section({ title, content }) {
  return (
    <>
      <h2 style={{ fontFamily: "para_font" }} className="text-2xl ">{title}</h2>
      <p>{content}</p>
    </>
  );
}
...
function ListSection({ title, items }) {
  return (
    <>
      <h2 style={{ fontFamily: "para_font" }} className="text-2xl  mt-4">{title}</h2>
