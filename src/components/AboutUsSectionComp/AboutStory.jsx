...
function AboutStory() {
  return (
    <section
      ...
      className="flex items-center justify-center pb-20 bg-zinc-100"
      itemScope
    ...
    >
      ...
      >
        ...
        <div className="relative bg-white rounded-3xl p-4 sm:p-6 md:p-10 shadow-md border border-zinc-100" itemProp="articleBody">
