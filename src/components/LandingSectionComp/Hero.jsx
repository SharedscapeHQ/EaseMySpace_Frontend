...
const propertyOptions = [
  ...
  { value: "profiles", label: "🏠 Shared Flat" },
  { value: "vacant_listings", label: "🏢 Fully Vacant Flat" },
];
...
const Hero = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.gender) qs.append("gender", formData.gender);
    if (formData.property_type) qs.append("type", formData.property_type);
    ...
    <>
      <section className="w-full">
            ...
            <div className="text-center lg:text-left max-w-4xl mx-auto">
              ...
              <div className="flex justify-center">
                <motion.form
                  ...
                  className="bg-white/80 backdrop-blur-xl text-zinc-700 font-medium flex flex-col sm:flex-row flex-wrap justify-center gap-4 items-center shadow-2xl p-6 rounded-tl-[3rem] rounded-tr-md rounded-br-[3rem] rounded-bl-md w-full max-w-[900px] relative"
                >
                  {/* Search Input */}
                  <motion.div
                  ...
                  >
                    <input
                      ...
                      className="text-sm px-12 py-3 rounded-full border border-gray-300 w-full focus:outline-none focus:ring-4 focus:ring-teal-400 shadow-sm hover:shadow-md transition-all duration-300 bg-white"
                    />
                  ...
                  >
                    ...
                    >
                      <div className="relative">
                        <Listbox.Button className="relative w-full cursor-pointer rounded-full bg-white border border-gray-300 py-3 px-5 text-left shadow-sm focus:outline-none focus:ring-4 focus:ring-indigo-400">
                          <span className="block truncate">
                            {genderOptions.find((o) => o.value === formData.gender)?.label || "Preferred Gender"}
                          </span>
                  ...
                  >
                    ...
                    >
                      <div className="relative">
                        <Listbox.Button className="relative w-full cursor-pointer rounded-full bg-white border border-gray-300 py-3 px-5 text-left shadow-sm focus:outline-none focus:ring-4 focus:ring-indigo-400">
                          <span className="block truncate">
                            {propertyOptions.find((o) => o.value === formData.property_type)?.label || "Looking For"}
                          </span>
                          <span className="pointer-events-none absolute inset-y-0 right-4 flex items-center text-gray-500 select-none">
                            ▼
                          </span>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6 sm:gap-10 my-12 max-w-3xl mx-auto px-4">
          ...
          >
            <span className="relative z-10 flex items-center gap-2">✍️ List Your Property</span>
